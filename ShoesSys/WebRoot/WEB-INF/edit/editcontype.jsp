...
<body>
	...
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">修改合同类型</h3>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<s:form role="form" action="contype_update" method="post">
							...
							<div class="row" style="margin-top:30px; margin-bottom:10px">
								<div class="col-lg-4">
									...
									<div class="col-lg-9">
										<s:textfield type="text" class="form-control" name="ctid"
								...
								<div class="col-lg-4">
									...
									<div class="col-lg-9">
										<s:textfield type="text" class="form-control" name="cttype"
											 value="%{model.cttype}"></s:textfield>
									</div>
								</div>
								<div class="col-lg-4">
									<div class="col-lg-3">
									...
									<div class="col-lg-9">
										<s:textfield type="text" class="form-control" name="ctmore"
											 value="%{model.ctmore}" placeholder="请输入编号"></s:textfield>
									</div>
								</div>
							</div>
