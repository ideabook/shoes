								...
								<div class="col-lg-4">
									...
									<div class="col-lg-8">
										<s:textfield type="number" class="form-control" name="ccount"
											value="%{model.ccount}" placeholder="请输入合同金额"></s:textfield>
									</div>
								</div>
							...
							<div class="row" style="margin-top:20px; margin-bottom:10px">
								...
								<div class="col-lg-4">
									...
									<div class="col-lg-8">
										...
										<select class="form-control" id="confrom" name="select">
											<option>
							...
							<div class="row" >
								<div class="col-lg-6">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<textarea  value="%{model.cmore}"  class="form-control" name="cmore" rows="3"
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<textarea value="%{model.cpayinfo}" class="form-control" name="cpayinfo" rows="3"
