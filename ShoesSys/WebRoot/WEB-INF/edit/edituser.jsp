			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<s:form role="form" action="login_update" method="post">

							<div class="row" style="margin-top:30px; margin-bottom:10px">
								<s:hidden name="uid" value="%{model.uid}"></s:hidden>
								<div class="col-lg-4">
									<div class="col-lg-3">
									...
									<div class="col-lg-9">
										<s:textfield type="text" class="form-control" name="uname"
											value="%{model.uname}"   ></s:textfield>
									</div>
								</div>
								...
								<div class="col-lg-4">
									...
									<div class="col-lg-9">
										<s:textfield type="text" class="form-control" name="uloginname"
											  value="%{model.uloginname}"></s:textfield>
									</div>
								</div>
								<div class="col-lg-4">
									<div class="col-lg-3">
									...
									<div class="col-lg-9">
										<s:textfield type="text" class="form-control" name="upassword"
											 value="%{model.upassword}" placeholder="请输入密码"></s:textfield>
									</div>
								</div>
							</div>
