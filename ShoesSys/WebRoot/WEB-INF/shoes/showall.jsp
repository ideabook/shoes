							...
							<table width="100%"
								...
								<thead>
									<tr>
										...
										<th align="center">步数</th>
										<th align="center">gps1</th>
										<th align="center">gps2</th>
										<th align="center">时间</th>
									</tr>
								</thead>
								<tbody>
									<s:iterator value="status" var="d" status="b">

										<tr>
											<td align="center"><s:property value="#b.index+1" />
											<td align="center"><s:property value="#d.userName"></s:property>
											</td>
											<td align="center"><s:property value="#d.stepCounts"></s:property>
											</td>
											<td align="center"><s:property value="#d.longitude"></s:property>
											</td>
											<td align="center"><s:property value="#d.latitude"></s:property>
											</td>
											<td align="center"><s:date name="#d.stime"
