			...
			<div class="col-md-4 col-md-offset-4">
				<div class="login-panel panel panel-default">
					...
					<div class="panel-body">
						<form role="form" action="shoes_adduser2.action" method="post">
							<fieldset>
								...
								<div class="form-group">
									<input class="form-control" placeholder="密码"
										sytle="paddingleft:30dp" name="passWord" type="text">
								</div>
								<br> ${msg} <br>
						...
						<a href="ssologin.jsp">
							<button type="text" class="btn btn-success btn-lg btn-block">登陆</button>
						</a>
					</div>
