			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" action="shoes_update.action" method="post">
							<div class="row" style="margin-top:30px; margin-bottom:10px">
								...
								<div class="col-lg-4">
									<div class="col-lg-4">
										<label class="control-label">步数</label>

									</div>
									<div class="col-lg-8">
										<input type="number" class="form-control"  name="stepCounts"
											placeholder="请输入步数">
									</div>
								</div>
							</div>
									...
									<div class="col-lg-8">
										<div class=" input-append date form_datetime">
											<input class="form-control" size="16" type="text"
												name="sdate"  format="yyyy年MM月dd日 hh:mm:ss " readonly > <span class="add-on"><i
