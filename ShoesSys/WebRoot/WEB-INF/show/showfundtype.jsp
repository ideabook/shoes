...
<body>
		...
		<div class="row" style="margin-bottom: 20px" >
			<div class="col-lg-12">
				...
				<span class="pull-right"> <!-- /.row --> <a
					href="${pageContext.request.contextPath }/fundtype_toadd.action">
						<button class="btn  btn-outline btn-primary">添加资金来源类型</button> </a> </span>
			</div>
		</div>
							...
							<table width="100%"
								...
								<thead>
									<tr>
										...
										<th align="center">资金来源类型</th>
										<th align="center">资金总额</th>
										<th align="center">剩余总额</th>
								...
								<tbody>
									<s:iterator value="list" var="d" status="b">
										...
										<tr id="tr">
											...
											<td align="center"><s:property value="#d.fno"></s:property>
											</td>
											<td align="center"><s:property value="#d.ftype"></s:property>
											</td>
											<td align="center"><s:property value="#d.fcount"></s:property>
											</td>
											<td align="center"><s:property value="#d.fleft"></s:property>
											</td>
											<td align="center"><s:date	name="#d.fstart"  format="yyyy年MM月dd日" />

											</td>
											<td align="center"><s:date	name="#d.fend"  format="yyyy年MM月dd日" />
											</td>
											<td align="center"><s:property value="#d.fmore"></s:property>
											</td>
											<td align="center"><a
												href="${pageContext.request.contextPath }/fundtype_edit.action?fid=<s:property value="#d.fid"></s:property>"><i
													class="fa fa-edit fa-fw"></i> </a> &nbsp;&nbsp;&nbsp;&nbsp; <a
												href="javascript:void(0);"
												onclick="myFunction(<s:property value="#d.fid"></s:property>)"><i
													class="fa fa-times fa-fw"></i> </a>
											</td>
											<td align="center"><a
											href="${pageContext.request.contextPath }/fundtype_find.action?fid=<s:property value="#d.fid"></s:property>">查看详情<i
	...
	<script>
			function myFunction(id) {
				...
				var r = confirm("确定删除吗");
				if (r == true) {
					window.location.href="${pageContext.request.contextPath }/fundtype_delete.action?fid="+id;
				} else {
