...
<body>
		...
		<div class="row" style="margin-bottom: 20px" >
			<div class="col-lg-12">
				...
				<span class="pull-right"> <!-- /.row --> <a
					href="${pageContext.request.contextPath }/contype_toadd.action">
						<button class="btn  btn-outline btn-primary">添加合同类型</button> </a> </span>
			</div>
		</div>
								...
								<tbody>
									<s:iterator value="list" var="d" status="b">
										...
										<tr id="tr">
											...
											<td align="center"><s:property value="#d.cttype"></s:property>
											</td>
											<td align="center"><s:property value="#d.ctmore"></s:property>
											</td>
											<td align="center"><a
												href="${pageContext.request.contextPath }/contype_edit.action?ctid=<s:property value="#d.ctid"></s:property>"><i
													class="fa fa-edit fa-fw"></i> </a> &nbsp;&nbsp;&nbsp;&nbsp; <a
												href="javascript:void(0);"
												onclick="myFunction(<s:property value="#d.ctid"></s:property>)"><i
	...
	<script>
			function myFunction(id) {
				...
				var r = confirm("确定删除吗");
				if (r == true) {
					window.location.href="${pageContext.request.contextPath }/contype_delete.action?ctid="+id;
				} else {
