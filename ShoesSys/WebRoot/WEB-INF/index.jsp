					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-9 text-right">
								<div  class="huge"><s:property value="#cnums"/></div>
								<div>合同总数</div>
							</div>
						</div>
					</div>
				...
				<div class="panel panel-green">
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-9 text-right ">
								<div class="huge2"  style=" margin-top:10px;"><s:property value="#ccount"/></div>
				...
				<div class="panel panel-yellow">
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-9 text-right">
								<div class="huge2" style=" margin-top:10px;"><s:property value="#cpaid"/></div>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				快速查找： <a
					...
					<button class="btn btn-outline btn-primary" data-toggle="modal"
						data-target="#myModal">2016年合同</button> </a> <a
					href="${pageContext.request.contextPath }/contractinfo_findbyyear.action?year=2017">
					<button class="btn btn-outline btn-primary" data-toggle="modal"
						data-target="#myModal">2017年合同</button> </a> <a
					href="${pageContext.request.contextPath }/contractinfo_findbyyear.action?year=2018">
					<button class="btn btn-outline btn-primary" data-toggle="modal"
						data-target="#myModal">2018年合同</button> </a> <span class="pull-right">
					<!-- /.row --> <a
							...
							<div id="panel" class="panel panel-info">
								...
								<div class="panel-body">
									...
									<label>公司名称：<s:property value="#d.companyinfo.comname" />
											...
											value="#d.fundtype.ftype" /> </label><br> <label>合同来源：<s:property
											value="#d.confrom.cffrom" /> </label> <br> <label>合同类型：<s:property
											value="#d.contype.cttype" /> </label>
