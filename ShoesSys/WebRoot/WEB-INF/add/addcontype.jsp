...
<body>
	...
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">添加合同类型</h3>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" action="contype_add" method="post">
							<div class="row" style="margin-top:30px; margin-bottom:10px">
								<div class="col-lg-4">
									...
									<div class="col-lg-9">
										<input type="text" class="form-control" name="cttype"
											id="cttype" placeholder="合同类型">
									</div>
								</div>
								...
								<div class="col-lg-4">
									...
									<div class="col-lg-9">
										<input type="text" class="form-control" name="ctmore"
							...
							<div class="row" style="margin-top:20px; margin-bottom:10px">
								...
								<div class="col-lg-12">
									<center>
										<!-- /.row -->
										<button type="submit" id="btn"  class="btn btn-primary">添加合同类型</button>
									</center>
								</div>
							</div>
						</form>
