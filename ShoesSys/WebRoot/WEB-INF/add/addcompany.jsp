...
<body>
	...
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">添加公司信息</h3>
						...
						<form role="form" action="company_add" method="post">
								...
								<div class="col-lg-4">
									...
									<div class="col-lg-8">
										<input type="text" class="form-control" name="comname"
											id="lastname" placeholder="请输入公司名称">
									</div>
								</div>
								<div class="col-lg-4">
									<div class="col-lg-4">
							...
							<div class="row" style="margin-top:20px; margin-bottom:10px">
								<div class="col-lg-4">
									...
									<div class="col-lg-8">
										<input type="text" class="form-control" name="combank"
											  placeholder="请输入银行卡号">
									</div>
								</div>
								<div class="col-lg-4">
									...
									<div class="col-lg-8">
										<input type="text" class="form-control" name="comcontacts"
											 placeholder="请输入联系人">
									</div>
							...
							<div class="row" style="margin-top:20px; margin-bottom:10px">
								<div class="col-lg-4">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control"  
												name="commore" placeholder="请输入备注">
										</div>
									</div>
								</div>
							...
							<div class="row" style="margin-top:20px; margin-bottom:10px">
								...
								<div class="col-lg-12">
									<center>
										<!-- /.row -->
										<button class="btn btn-primary">添加公司信息</button>
									</center>
								</div>
